    ...
    (() => {
        ...
        function rangeInit() {
            ...
            if (sliderItems.length) {
                ...
                sliderItems.forEach(((sliderItem, index) => {
                    ...
                    if (index > 0) item.noUiSlider.options.format.to = function(value) {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".main-page__slider")) {
                const mainSlider = new core(".main-page__slider", {
                ...
                document.querySelectorAll(".slidermain__bullets .swiper-pagination-bullet i").forEach((item => {
                    item.addEventListener("animationend", (() => {
                        if (mainSlider.isEnd) mainSlider.slideTo(0); else {
            ...
            if (document.querySelector(".product-news__slider")) new core(".product-news__slider", {
                modules: [ Pagination, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
            ...
            if (document.querySelector(".image-product__subslide")) subSlider = new core(".image-product__subslide", {
                modules: [],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
            ...
            if (document.querySelector(".image-product__mainslider")) new core(".image-product__mainslider", {
        ...
        function menuAction(e) {
            ...
            if (targetElement.classList.contains("catalog-header__link") && targetElement.closest(".catalog-header__item").querySelector(".submenu-header")) {
                ...
                } else menuItem.classList.remove("_active");
            } else if (!targetElement.closest(".catalog-header__item")) document.querySelectorAll(".catalog-header__item").forEach((item => item.classList.remove("_active")));
            ...
            if (targetElement.closest(".catalog-header__back")) document.documentElement.classList.remove("submenu-open");
            if (targetElement.closest(".submenu-header__back")) document.querySelectorAll(".catalog-header__item").forEach((item => item.classList.remove("_active")));
            if (targetElement.closest(".submenu-header__category")) {
                targetElement.closest(".submenu-header__column").classList.add("_active");
                e.stopPropagation();
            }
            if (targetElement.closest(".submenu-header__back-list")) document.querySelectorAll(".submenu-header__column").forEach((item => item.classList.remove("_active")));
        }
        document.addEventListener("selectCallback", (function(e) {
            ...
            switch (currentSelect.options[currentSelect.selectedIndex].innerHTML) {
              case "Узбекистан":
                if (subSelectTitle) subSelectTitle.innerHTML = "";
